            ...
            {projects.map((project, index) => (
              ...
              >
                <Card 
                  ...
                  className={`p-6 h-full bg-card/50 backdrop-blur-sm border-border hover:border-primary/50 hover:shadow-[var(--card-glow)] transition-all duration-300 group ${project.link ? 'cursor-pointer' : ''}`}
                >
